...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/ShamimCyber/Random/blob/main/Khadija.txt').text
        ff=open('show.txt','w')
...
def banner():
 ...
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97SHAMIM \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97SHAMIM \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100018977162337')
       main()  
